...
Show a table with Month, payed so far at that month and remaining debt.
Also, the total amount that Dave will have to pay over the life of the mortgage and number of months to do so.\n
""")
...
extra_payment_end_month = int(input('Enter extra_payment end month: (108) ') or '108')

print('Month \t Total paid \t Remaining debt')
while principal > 0:
